...
@Configuration
@EnableJpaRepositories("com.ua.pim_schema_tool.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.ua.pim_schema_tool.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.ua.pim_schema_tool.config.HerokuDatabaseConfiguration")
